"""
Startup validation for Project Grimoire.
...
class CheckResult:
    ...
    be fixed before Grimoire can do useful work and "warning" for things that
...
class PreflightChecker:
    ...
    default shared-retry session from :py:mod:`grimoire.utils.http`.
    """
