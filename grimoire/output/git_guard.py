...
This module provides automatic Git snapshots before Grimoire modifies any file.
...
class GitGuard:
    ...
    def commit_pre_change(self, file_path: str, reason: str = "grimoire: pre-change snapshot"):
        """
        Commits any pending changes in the specified file before Grimoire modifies it.
